...
import { NcModel } from './../../models/nc-model';
...
@Component({
  selector: 'app-roadmap-incidente-crud',
  templateUrl: './incidente-insumo-nc.page.html',
  styleUrls: ['./incidente-insumo-nc.page.scss'],
})
export class IncidenteInsumoNcPage implements OnInit, OnDestroy {
  ...
  getNcs() {
    this.ncService.getResults().subscribe(
      (res: any) => {
        this.ncs = res;
      },
      (err) => {
